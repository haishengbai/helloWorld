...
package qycf.hello.world.java.eight.validating.tests;
import java.util.*;
import java.util.function.*;
import java.util.stream.*;
import org.junit.jupiter.api.*;
import qycf.hello.world.java.eight.validating.Inverter1;
import qycf.hello.world.java.eight.validating.Inverter2;
import qycf.hello.world.java.eight.validating.Inverter3;
import qycf.hello.world.java.eight.validating.Inverter4;
import qycf.hello.world.java.eight.validating.StringInverter;
