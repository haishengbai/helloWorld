package qycf.hello.world.java.eight.collections;// collections/CollectionDifferences.java
// (c)2020 MindView LLC: see Copyright.txt
// We make no guarantees that this code is fit for any purpose.
// Visit http://OnJava8.com for more book information.

import qycf.hello.world.java.eight.onjava.CollectionMethodDifferences;
